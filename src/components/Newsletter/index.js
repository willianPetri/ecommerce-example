...
import foto from '../../images/subscribe-banner.png'
    ...
    <div className='rounded-lg shadow-lg my-20 flex flex-row'>
      <div className="lg:w-3/5 w-full bg-gradient-to-r from-black to-purple-900 lg:from-black lg:via-purple-900 lg:to-transparent rounded-lg text-gray-100 p-12">
        <div className="lg:w-1/2">
          ...
          <p className="mb-3 leading-relaxed">Want to hear from us when we have new offers? Sign up for our newsletter and we'll email you every time we have new sale offers.</p>
          <div>
            ...
            <button className="bg-red-600 py-3 rounded-lg w-full">Subscribe</button>
          </div>
        </div>
      </div>      
      <div className="lg:w-2/5 w-full lg:flex lg:flex-row hidden">
        <img src={foto} alt="" className='h-96' />
      </div>
    </div>
  )
}
